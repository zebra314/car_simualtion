...
def forward(velocity):
    ...
    pub_RF = rospy.Publisher('/car/RF_wheel_velocity_controller/command', Float64, queue_size=10)
    pub_LF = rospy.Publisher('/car/LF_wheel_velocity_controller/command', Float64, queue_size=10)
    pub_RB = rospy.Publisher('/car/RB_wheel_velocity_controller/command', Float64, queue_size=10)
    pub_LB = rospy.Publisher('/car/LB_wheel_velocity_controller/command', Float64, queue_size=10)
